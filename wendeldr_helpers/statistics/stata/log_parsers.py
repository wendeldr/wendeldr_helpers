...
def parse_univariate_log(file, header=0, footer=11):
    ...
    longitudinal_df = pd.read_csv(file,header=None,names=longitudinal_header,skiprows=header+1,skipfooter=footer)
